...
//        Client mappedBackClient = ClientMapper.toClient(clientEnt);
//
...
//
//        AdminEnt adminEnt = ClientMapper.toAdminEnt(admin);
//        Admin mappedBackAdmin = ClientMapper.toAdmin(adminEnt);
//
...
//
//        ManagerEnt managerEnt = ClientMapper.toManagerEnt(manager);
//        Manager mappedBackManager = ClientMapper.toManager(managerEnt);
//
