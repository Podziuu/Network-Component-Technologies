...
public class ComicsEntDTO extends ItemEntDTO {
    ...
    public ComicsEntDTO(String id, int basePrice, String itemName, boolean available, int pagesNumber, String publisher) {
