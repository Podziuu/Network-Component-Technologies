...
public class ItemMapper {
    ...
    public static Item toSoapItem(pl.tks.model.item.Item item) {
    ...
    // Maper dla Music
    private static Music toMusicSoap(pl.tks.model.item.Music music) {
    ...
    // Maper dla Movie
    private static Movie toMovieSoap(pl.tks.model.item.Movie movie) {
    ...
    // Maper dla Comics
    private static Comics toComicsSoap(pl.tks.model.item.Comics comics) {
    ...
    public static List<Item> toSoapItemList(List<pl.tks.model.item.Item> items) {
        return items.stream().map(ItemMapper::toSoapItem).collect(Collectors.toList());
    }

    public static pl.tks.model.item.Item fromSoapItem(Item item) {
    ...
    private static pl.tks.model.item.Music fromMusicSoap(Music soapMusic) {
        pl.tks.model.item.Music music = new pl.tks.model.item.Music();
    ...
    private static pl.tks.model.item.Movie fromMovieSoap(Movie soapMovie) {
        pl.tks.model.item.Movie movie = new pl.tks.model.item.Movie();
    ...
    private static pl.tks.model.item.Comics fromComicsSoap(Comics soapComics) {
        pl.tks.model.item.Comics comics = new pl.tks.model.item.Comics();
    ...
    public static List<pl.tks.model.item.Item> fromSoapItemList(List<Item> items) {
