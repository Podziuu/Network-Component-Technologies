...
public class ItemEndpointTest {
    ...
    void addComics_addsAndReturnsComics() {
        ...
        pl.tks.model.item.Comics addedItem = new pl.tks.model.item.Comics();
    ...
    void addMovie_addsAndReturnsMovie() {
        ...
        pl.tks.model.item.Movie addedItem = new pl.tks.model.item.Movie();
    ...
    void addMusic_addsAndReturnsMusic() {
        ...
        pl.tks.model.item.Music addedItem = new pl.tks.model.item.Music();
